...
CREATE TABLE AVIACAO.COMPRADOR (
  ...
  id_comprador,
  PRIMARY KEY (id_usuario),
  CONSTRAINT FK_COMPRADOR_ID_USUARIO FOREIGN KEY (id_comprador) REFERENCES USUARIO(id_usuario)
);
...
CREATE TABLE AVIACAO.COMPANHIA (
  ...
  id_companhia,
  PRIMARY KEY (id_usuario),
  CONSTRAINT FK_COMPANHIA_ID_USUARIO FOREIGN KEY (id_companhia) REFERENCES USUARIO(id_usuario)
);
...
CREATE TABLE AVIACAO.TRECHO (
  ...
  CONSTRAINT FK_TRECHO_ID_COMPANHIA FOREIGN KEY (id_companhia) REFERENCES COMPANHIA(id_usuario)
);
