...
CREATE TABLE AVIACAO.AVIAO(
	id_aviao NUMBER,
	codigo_aviao NUMBER(6) NOT NULL,
	aeroporto_origem VARCHAR2(15) NOT NULL,
	aeroporto_destino VARCHAR2(15) NOT NULL,
	capacidade NUMBER NOT NULL,
	wifi CHAR(1) NOT NULL,
	sistema_de_entreterimento CHAR(1) NOT NULL,
