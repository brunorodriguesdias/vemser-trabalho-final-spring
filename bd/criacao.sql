...
CREATE TABLE AVIACAO.CARGO (
	id_cargo NUMBER,
	nome VARCHAR2(50) NOT NULL,
	PRIMARY KEY (id_cargo)
);

CREATE TABLE AVIACAO.USUARIO_CARGO (
	id_cargo NUMBER,
	id_usuario NUMBER,
	CONSTRAINT FK_ID_CARGO FOREIGN KEY (id_cargo) REFERENCES CARGO(id_cargo),
	CONSTRAINT FK_ID_COMPRADOR FOREIGN KEY (id_usuario) REFERENCES USUARIO(id_usuario)
);
...
CREATE SEQUENCE AVIACAO.seq_cargo
START WITH 1
INCREMENT BY 1
NOCACHE NOCYCLE;
